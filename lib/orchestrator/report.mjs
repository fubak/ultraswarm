...
export function buildReport({ merged = [], failed = [], blocked = [], externalTokens = 0, attempts = {}, taskCount, tokenCoverage, workerAttempts = 0, externalWallMs = 0 } = {}) {
  ...
  if (externalTokens > 0) {
    ...
    lines.push(`Workers reported ≈ ${externalTokens.toLocaleString()} tokens of usage${cov}.`)
  } else {
